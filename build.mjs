...
page('/aviso-legal/', renderSimplePage({
  ...
  <p><b>Titularidad.</b> Este sitio web (farofx.org, en adelante «FAROFX») es un proyecto editorial independiente de análisis y comparación de brokers de forex y CFD. Para cualquier cuestión relativa a la titularidad, los contenidos o el ejercicio de derechos, puede escribirnos a <a href="mailto:contacto@farofx.org" style="color:var(--seal)">contacto@farofx.org</a>.</p>
