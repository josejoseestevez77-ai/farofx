...
page('/privacidad/', renderSimplePage({
  ...
  <p><b>Responsable del tratamiento.</b> Finverse SL (España), titular de farofx.org. Contacto: <a href="mailto:contacto@farofx.org" style="color:var(--seal)">contacto@farofx.org</a>.</p>
