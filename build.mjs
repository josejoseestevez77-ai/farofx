...
page('/aviso-legal/', renderSimplePage({
  ...
  <p><b>Titularidad.</b> Este sitio web, <b>farofx.org</b> (en adelante «FAROFX»), es un proyecto editorial independiente de análisis y comparación de brokers de forex y CFD. Correo de contacto: <a href="mailto:contacto@farofx.org" style="color:var(--seal)">contacto@farofx.org</a>.</p>
...
page('/privacidad/', renderSimplePage({
  ...
  <p><b>Responsable del tratamiento.</b> El responsable del tratamiento de tus datos es el titular de farofx.org. Contacto: <a href="mailto:contacto@farofx.org" style="color:var(--seal)">contacto@farofx.org</a>.</p>
